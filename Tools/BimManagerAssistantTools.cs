...
namespace ApsSamples.Tools
{
        ...
        IConfiguration configuration)
    {
        ...
        [Description("Lists the Revit models in the current project that have never been published successfully - i.e. models with no completed publish job on record. Use this to answer questions like 'which models are unpublished'. Always show each model's name and item ID together to the user (e.g. \"Model: Architecture.rvt - Id: <itemId>\"), so the ID stays visible in the conversation for later turns.")]
